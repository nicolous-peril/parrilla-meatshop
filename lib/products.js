...
export function formatWeightLabel(weight) {
  const value = typeof weight === "object" ? (weight.value ?? weight.weight_value) : weight;
  ...
  const label = typeof weight === "object" ? (weight.label || weight.weight_label) : "";
  return label || "";
}
